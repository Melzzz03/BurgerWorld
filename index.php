...
<header class="header">
   ...
   <a href="#home" class="logo">
    <img src="images/LogoBurgerWorld.jpg"/>
    <span>Burger </span>World
</a>
      ...
      <nav class="navbar">
         ...
         <a href="#faq">faq</a>
         <a href="Manual/UM CUSTOMER.pdf" target="_blank" class="usermanual">User Manual</a>
      </nav>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/Fresh beef burger isolated -1.png" alt="">
            </div>
            <div class="content">
               <h3>Fresh Beef Burger</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/09add236-69da-4a26-9990-6989d9a4fea3.png" alt="">
            </div>
            <div class="content">
         ...
         <div class="slide">
            <div class="image">
               <img src="images/c59738b6-52a9-4f55-87c1-c6cc52ba2606.png" alt="">
            </div>
            <div class="content">
               <h3>Super Special Burger</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>We will always try to provide the best quality of our food to the customer to fulfill their expectation. We will also try to improve our food to satisfy our customer. </p>
      ...
      <div class="box">
         ...
         <p>Our shop places great emphasis on time-related matters. Thus, we will always try to ensure that the food arrive right on time so that you can enjoy your food with a maximum pleasure.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>

      <div class="box">
         <img src="images/about-3.svg" alt="">
         <h3>variety of menu choices</h3>
         <p>Our shop does not only sells burger. Besides, our shop also provide sides menu for the customer such as, coney cheese fries, chicken wing and etc. </p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" name="number" class="box" required placeholder="enter your number" min="0" max="999999999999" onkeypress="if(this.value.length == 12) return false;">
         </div>
         <div class="inputBox">
            <span>payment method</span>
            <select name="method" class="box">
               <option value="cash on delivery">cash on delivery</option>
               <option value="Duit Now QR">Duit Now QR</option>
            </select>
         </div>
         <div class="inputBox">
...
<section class="faq" id="faq">
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         Firstly you must register, and then log in your account after that you can order your food and fill the order form.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>How will I know if Burger World has received my online order?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         An order confirmation phone number will be sent to your registered phone number once your order has been submitted.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>can I pay using QR pay?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Yes, for delivery our staff will give the QR Code when delivered the orders.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>What do I do if my order arrived with missing items? </span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
         Please call Burger World at +6017-294-4941 to inform of your missing items. We will arrange for the items to be delivered to you in the soonest time possible.
         </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>Is the food Halal?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Our Food is using 100% Halal ingredients.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>opening hours</h3>
         <p>03:30pm to 12:00am</p>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>email address</h3>
         <p>Burgerworld2005@gmail.com</p>
         <p></p>
      </div>
   ...
   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>BurgerWorld</span> | all rights reserved!
   </div>
